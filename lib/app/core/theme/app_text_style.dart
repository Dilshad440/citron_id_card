...
class _MyTextStyle extends TextStyle {
  ...
  _MyTextStyle get regular =>
      _MyTextStyle(copyWith(fontWeight: FontWeight.w400));

  _MyTextStyle get medium =>
      _MyTextStyle(copyWith(fontWeight: FontWeight.w500));

  _MyTextStyle get semiBold =>
      _MyTextStyle(copyWith(fontWeight: FontWeight.w600));

  _MyTextStyle get bold => _MyTextStyle(copyWith(fontWeight: FontWeight.w700));

  _MyTextStyle get lightWeight =>
      _MyTextStyle(copyWith(fontWeight: FontWeight.w300));

  _MyTextStyle get blackHeavy =>
      _MyTextStyle(copyWith(fontWeight: FontWeight.w900));

  _MyTextStyle get italic =>
      _MyTextStyle(copyWith(fontStyle: FontStyle.italic));

  _MyTextStyle get ellipsis =>
      _MyTextStyle(copyWith(overflow: TextOverflow.ellipsis));
